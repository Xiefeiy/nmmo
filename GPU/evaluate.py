...
def save_replays(policy_store_dir, save_dir, curriculum_file, task_to_assign=None):
    ...
    team_agent.mixnet.load_state_dict(torch.load('./QMIX/model/team_1500.pth'))
    team_agent.target_mixnet.load_state_dict(torch.load('./QMIX/model/team_1500.pth'))
    for i in range(8):
        team_agent.agents[i].net.load_state_dict(torch.load('./QMIX/model/agent_1500.pth'))
