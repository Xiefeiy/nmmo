...
def save_replays(policy_store_dir, save_dir, curriculum_file, task_to_assign=None):
    ...
    while True:
        ...
        # print(type(actions), actions.shape)             # <class 'torch.Tensor'>  torch.Size([128, 12])
        
        evaluator.buffers[0].send(actions.cpu().numpy(), None)
        o, r, d, i = evaluator.buffers[0].recv()

        # print(type(o), o.shape)         # <class 'numpy.ndarray'> (128, 26035)
        # print(type(r), len(r))          # <class 'list'> 128
        # print(type(d), len(d))          # <class 'list'> 128
        # print(type(i), len(i))          # <class 'list'> 1
...
if __name__ == "__main__":
    ...
    ckpt_paths = {
        "20240527": "/tmp/runs/nmmo_20240527_180147/policy_store/nmmo_20240527_180147.000030",
        "20240528a-fake1M": "/tmp/runs/nmmo_20240528_092543/policy_store/nmmo_20240528_092543.000001",
        "20240528b-fake1kw": "/tmp/runs/nmmo_20240528_103101/policy_store/nmmo_20240528_103101.000001",
        "20240528c-real1kw": "/tmp/runs/nmmo_20240528_202617/policy_store/nmmo_20240528_202617.000001",
        "20240529-real1M": "/tmp/runs/nmmo_20240529_102613/policy_store/nmmo_20240529_102613.000001",
    }
